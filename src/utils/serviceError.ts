...
export const createServiceError = (code: string, message: string, field?: string) => {
...
export const handleSupabaseError = (error: any, context?: string) => {
  ...
  return new ServiceError('DATABASE_ERROR', error.message || 'An unknown database error occurred')
}
