...
const trendData: PropertyTrendData[] = [
  { month: '3월', 등록: 45, 판매완료: 32, 예약중: 8 },
  { month: '4월', 등록: 52, 판매완료: 38, 예약중: 12 },
  { month: '5월', 등록: 48, 판매완료: 35, 예약중: 10 },
  { month: '6월', 등록: 61, 판매완료: 42, 예약중: 15 },
  { month: '7월', 등록: 55, 판매완료: 39, 예약중: 13 },
  { month: '8월', 등록: 67, 판매완료: 45, 예약중: 18 },
]
